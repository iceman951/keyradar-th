...
import { editionAvailabilityDtoSchema, offerSnapshotDtoSchema } from '../schemas/offer.schema';
...
export const offerRoutes = (pricing: PricingService) =>
  new Elysia()
    .get(
      '/games/:slug/offers',
      { params: slugParams, query: editionKeyQuery, response: { 200: offerSnapshotDtoSchema } },
    ...
    .get(
      '/games/:slug/editions',
      { params: slugParams, response: { 200: t.Array(editionAvailabilityDtoSchema) } },
      async ({ params, set }) => {
