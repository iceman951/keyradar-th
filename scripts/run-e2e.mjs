...
try {
  ...
  const targets = process.argv.slice(2).length > 0 ? process.argv.slice(2) : ['e2e/app.spec.ts'];
  const tests = spawn(process.execPath, ['node_modules/@playwright/test/cli.js', 'test', ...targets], {
    cwd: root,
    stdio: 'inherit'
  });
